...
class ProfileUtils {
  /// Generates a list of mock user profiles for testing purposes.
  ///
  /// Returns a list of [UserProfile] objects with predefined data.
  static List<UserProfile> generateMockProfiles() {
    return [
      UserProfile(
        id: '1',
        name: 'Sarah Chen',
